...
public class Test2 {
  ...
  public static void openUserFile(String filename) throws Exception{
    ...
    for (int i = 0; i < list.size(); i++) {
      ...
      // System.out.println(list.getEncoding());
    ...
    */
    ...
    for (ch myAl : list) {
      ...
      System.out.println(ch.getEncoding());
    }
    */
  ...
  public static void encodeString(String input) {
    ...
    for (int i = 0; i < string_Char.length; i++) {
      for (MorseCode j : list) {

        // if character is lower case, change to uppercase. Check if current character equals character in array
        ...
        // Check if current character equals character in array
    ...
    for (int i = 0; i < string_Char.length; i++) {
      ...
      else if (list.contains(string_Char[i])) {
        int a = list.indexOf(string_Char[i]);
        // System.out.print(enc.get(a)+ " ");
      }
  ...
  public static void main(String[] args) throws Exception{
    ...
    // String input = "   ";
    // encodeString(input);
    String encode_file = "TestFile.txt";
